                ...
                <div className="search-field">
                    <div class="relative">
                        ...
                        <div>
                            ...
                            <button onClick={handleClick} type="submit" class="text-white absolute right-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-stone-200 dark:hover:bg-blue-700 dark:focus:ring-blue-800 search-button">Search</button>
                        </div>
                    </div>
                </div>
            </form>
